<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuccessCaseItem.aspx.cs" Inherits="TYNMU.User.Success.SuccessCaseItem" %>
...
<body>
    ...
    <div style="width: 80%; height: auto; font-size: x-large;" align="center">
        ...
        <div id="div_success" runat="server" style="width: 80%; height: auto; font-size: large;" align="left">
        </div>
    </div>
    </form>
</body>
