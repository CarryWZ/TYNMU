<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuccessCaseList.aspx.cs" Inherits="TYNMU.User.Success.SuccessCaseList" %>
...
<body>
    ...
    <asp:DataList ID="DLNewslist" runat="server" Width=100% BackColor="White" 
        ...
        <div class="news_a">
            <dl class="clearfix">
                <dt><a href='SuccessCaseItem.aspx?SuccID=<%# Eval("ID") %>'><%# Eval("image") %></a></dt>
                <dd>
                    <div class="title">
                        <em>[<%# Eval("time","{0:yyyy-MM-dd}") %>]</em>
                    </div>
                    <div class="des"> <%# Eval("name") %>... </div>
                    <a href='SuccessCaseItem.aspx?SuccID=<%# Eval("ID") %>' class="more">  + 查看详情</a>
                </dd>
            </dl>
        </div>
    </div>
